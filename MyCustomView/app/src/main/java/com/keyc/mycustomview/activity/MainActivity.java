...
import com.keyc.mycustomview.view.FirstCustomView;
...
public class MainActivity extends AppCompatActivity {
    ...
    private FirstCustomView mFirstCustomView;
...
//        mFirstCustomView = (FirstCustomView) findViewById(R.id.FirstCustomView);
//        mFirstCustomView.setOnClickListener(new FirstCustomView.OnClickListener(){
//
//            @Override
...
//        });
        ...
        hv = (HVScrollView) findViewById(R.id.hv_scrollview);
...
//            把button通过布局add到页面里
            ...
            layoutParams[i].leftMargin = button_y + i * bt_paly_y;
            layoutParams[i].topMargin = button_x;
