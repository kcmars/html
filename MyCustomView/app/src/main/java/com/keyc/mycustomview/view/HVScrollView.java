 ...
 */
 public class HVScrollView extends FrameLayout {
     ...
     /**
      * True when the test has changed but the traversal has not come through yet.
      ...
      * test is dirty. This prevents the scroll from being wrong if the child has not been
