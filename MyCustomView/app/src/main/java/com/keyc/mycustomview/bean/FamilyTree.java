...
public class FamilyTree {
    ...
    public FamilyTree(NodeModel2 tree, FamilyTree parent, float number, float depth) {
        this.x = -1.f;
        this.y = depth;
        this.tree = tree;
        this.children = new ArrayList<>();
        for (int i = 0; i < tree.getChildren().size(); i++) {
            NodeModel2 childrenNode = tree.getChildren().get(i);
    ...
    public NodeModel2 getTree() {
        return tree;
    }

    public void setTree(NodeModel2 tree) {
        this.tree = tree;
    }
