(function($) {
    $.pay = {
        ...
        _show: function(moneyText, showType, callback) {
            ...
            _html +=  '<div id="mp-box-title"><img id="mp-img-close" src="../Bus/img/icon_gray_close.png" />';
            _html += '<span id="title">支付</span><span id="title-right"></span></div>';
            _html += '<div id="mp-alert-pay-type"><div id="mp-alert-pay-type-row1">';
            _html += '<img id="img1" src="../Pay/img/wechat_pay.png" /><span id="span1">微信支付</span><input id="input1" name="radio" type="radio" checked="checked" value="weixin"/>';
            _html += '</div><div id="mp-alert-pay-type-row2"><img id="img2" src="../Pay/img/alipay.png" />';
