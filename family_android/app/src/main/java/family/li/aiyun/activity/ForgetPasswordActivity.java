...
public class ForgetPasswordActivity extends AppActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.ll_country:  //选择地区国家
                intent.setClass(ForgetPasswordActivity.this, CountryCodeActivity.class);
    ...
    private void submit() {
        ...
        String area_code = mEtSmsCode.getText().toString();
        ...
        param.put("sms_code", area_code);
        param.put("password", password);
        param.put("password_confirm", password);
        HttpManager.getInstance().post("index/login/forgetPwd", param, new HttpRequestCallback() {
            @Override
            public void requestSuccess(Object data, String msg) {
                ToastUtil.showToast(msg);
                finish();
