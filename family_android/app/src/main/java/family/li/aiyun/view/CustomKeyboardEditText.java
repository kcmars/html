...
public class CustomKeyboardEditText extends EditText implements KeyboardView.OnKeyboardActionListener, View.OnClickListener {
    ...
    private void initKeyboardView(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, family.li.aiyun.R.styleable.Keyboard);
        ...
        // 设置PopupWindow的背景
        mKeyboardWindow.setBackgroundDrawable(new ColorDrawable(getResources().getColor(R.color.colorBtn)));
        array.recycle();
