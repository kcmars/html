...
public class CountryRecyclerView extends FrameLayout implements SideBarView.LetterTouchListener {
    ...
    public CountryRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CountryRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        View view = LayoutInflater.from(context).inflate(family.li.aiyun.R.layout.country_list_layout, this);
        mTvLetterShow = (TextView) view.findViewById(family.li.aiyun.R.id.tv_letter_show);
        mLlTopTitle = (LinearLayout) view.findViewById(family.li.aiyun.R.id.ll_top_title);
        mTvLetter = (TextView) view.findViewById(family.li.aiyun.R.id.tv_letter);
        mSideBarView = (SideBarView) view.findViewById(family.li.aiyun.R.id.view_sidebar);
        mRecyclerView = (RecyclerView) view.findViewById(family.li.aiyun.R.id.recycler_view);
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener(){
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                // 检查列表中的letter布局是否显示
                if (view1 != null && view1.getTop() <= mLetterHeight && ((TextView) view1.findViewById(family.li.aiyun.R.id.tv_letter)).getVisibility() == View.VISIBLE){
                    //被顶掉的效果
